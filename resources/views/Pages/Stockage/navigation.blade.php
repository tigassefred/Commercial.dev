<div class="d-flex justify-content-center mt-3">
    ...
    <a href="{{route('stockage.index')}}" class="btn btn-outline-primary mr-4">Liste des articles</a>
    ...
    <a href="{{route('Gestion.index')}}" class="btn btn-outline-primary mr-4">Gestion de Stock</a>
    <a href="{{route('mouvement.index')}}" class="btn btn-outline-primary mr-4">Mouvement de stock</a>
